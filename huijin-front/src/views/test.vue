  ...
  export default {
    ...
    methods: {
      sendRequest() {
        ...
        const serverUrl = 'http://127.0.0.1/sts';
      ...
      getSignature() {
        ...
        // if (this.expire < this.now + 3) {
          ...
          const e = eval;
          const obj = e(`(${body})`).token;
          console.log(obj.AccessKeyId)
          this.host = obj.host;
          this.policyBase64 = obj.SecurityToken;
          this.accessid = obj.AccessKeyId;
          this.signature = obj.AccessKeySecret;
          this.expire = parseInt(obj.Expiration, 10);
      ...
      setUploadParam(up, filename, ret) {
        ...
        console.log(544545)
        console.log(newMultipartParams.OSSAccessKeyId)
        up.setOption({
          // url: this.host,
          url: 'http://dp-private.oss-cn-beijing.aliyuncs.com',
      ...
      upload() {
        ...
        const uploader = new plupload.Uploader({
          ...
          filters: {
            mime_types: [{
              title: '允许上传文件类型',
              extensions: 'jpg,gif,png,bmp,txt',
            }],
            // 最大只能上传200mb的文件
            max_file_size: '200mb',
            // 不允许队列中存在重复文件
